	...
	<div style="float: left; width: 200px;">
		<el-container>
			<el-aside  width="200px" style="background-color: rgb(238, 241, 246); ">
			  <el-menu :default-openeds="['1', '3']" class="aaa" style="border-right: none;">
				  
					<el-submenu index="1">
						<template slot="title"><i class="el-icon-message"></i>员工资料</template>
						<el-menu-item-group>
						<el-menu-item index="1-1" style="margin-top: -15px;"><a><router-link to='/Yuangong'>基本资料</router-link></a></el-menu-item>
						</el-menu-item-group>
					</el-submenu>
					...
					<el-submenu index="2">
						...
						<el-menu-item-group>
						<el-menu-item index="2-1" style="margin-top: -15px;">员工奖惩</el-menu-item>
					...
					<el-submenu index="3">
						...
						<el-menu-item-group>
						<el-menu-item index="3-1" style="margin-top: -15px;"><a><router-link to='/Ztgl'>工资账套管理</router-link></a></el-menu-item>
						<el-menu-item index="3-2"><a><router-link to='/Ztsz'>员工账套设置</router-link></a></el-menu-item>
					...
					<el-submenu index="4">
						...
						<el-menu-item-group>
						<el-menu-item index="4-1" style="margin-top: -15px;">综合信息统计</el-menu-item>
					...
					<el-submenu index="5">
						...
						<el-menu-item-group>
						<el-menu-item index="5-1" style="margin-top: -15px;"><a><router-link to='/Jcxxsz'>基础信息设置</router-link></a></el-menu-item>
